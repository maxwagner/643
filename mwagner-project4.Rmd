...
Using SVD for the matrix factorization method. I decided to fill in 0's for values that were NA. Another option is filling in by row average (user average).
